...
public class Facturacion extends javax.swing.JFrame {
         ...
         */
        public Facturacion(String trackingNumber, String nombreRemitente, String nombreDestinatario,
                        String fecha, String sucursalAceptoPaquete, String sucursalParaRecoger, String domicilio,
                        float peso, String tamanio, float subtotal, float iva, float ivaPorcentaje, double total,
                        String descripcionTarifa) {
                initComponents();
                String totalFormat = String.format("%.2f", total);
                lblCodigoTracking.setText(trackingNumber);
                lblFecha.setText(fecha);
                lblNombreRemitente.setText(nombreRemitente);
                lblDestinatario.setText(nombreDestinatario);
                lblCiudadOrigen.setText(sucursalAceptoPaquete);
                lblCiudadDestino.setText(sucursalParaRecoger);
                lblDescripcionPaquete.setText(tamanio + ", " + peso + "kg");
                lblDescripcionTarifa.setText(descripcionTarifa);
                lblSubtotal.setText("$ " + subtotal);
                lblIVA.setText("$ " + iva);
                lblIvaBdd.setText("Iva (" + ivaPorcentaje + "%)");
