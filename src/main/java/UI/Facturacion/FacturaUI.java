...
public class FacturaUI extends javax.swing.JFrame {
	...
	public FacturaUI(Factura factura) {
		initComponents();
		String totalFormat = String.format("%.2f", factura.getPrecio().getTotal());
		String subtotalFormat = String.format("%.2f", factura.getPrecio().getSubtotal());
		String ivaFormat = String.format("%.2f",
				factura.getPrecio().getIva() * factura.getPrecio().getSubtotal() / 100);
		String ivaPorcentajeFormat = String.format("%.1f", factura.getPrecio().getIva());
		lblCodigoTracking.setText(factura.getPaquete().getTracking());
		lblFecha.setText(factura.getFechaRegistro());
		lblNombreRemitente.setText(
				factura.getPaquete().getCliente().getNombre() + " " + factura.getPaquete().getCliente().getApellido());
		lblDestinatario.setText(factura.getPaquete().getNombreDestinatario());
		lblCiudadOrigen.setText(factura.getPaquete().getSucursalOrigen());
		lblCiudadDestino.setText(factura.getPaquete().getSucursalDestino());
		lblDescripcionPaquete.setText(
				factura.getPaquete().getTamanio() + ", " + factura.getPaquete().getPeso() + "kg");
		lblDescripcionTarifa.setText(factura.getPrecio().getDescripcion());
		...
		lblObservacion.setText(factura.getObservacion());
	...
	private void initComponents() {
		...
		lblObservacion.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
		lblObservacion.setVerticalAlignment(javax.swing.SwingConstants.TOP);
				...
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(layout.createSequentialGroup()
								...
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(lblObservacion, javax.swing.GroupLayout.DEFAULT_SIZE,
		...
		layout.setVerticalGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
								...
								.addComponent(jLabel21)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(lblObservacion, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
								.addContainerGap()));
